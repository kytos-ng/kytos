...
The proposed solutions are the same as the ones presented on `discussion 137 <https://github.com/kytos-ng/telemetry_int/discussions/137>`_. All in all, and based on AmLight's network requirements, proxy ports configurations must be optional, network engineers would like to have the most flexible option with default requirements.
